...
def cy_td_ode_rhs(
    ...
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], (0 if (t > 110.000000) else _td_array_0[int(round(199 * (t/110.000000)))]), out, num_rows)
    spmvpy(&data2[0], &idx2[0], &ptr2[0], &vec[0], (0 if (t > 110.000000) else _td_array_1[int(round(199 * (t/110.000000)))]), out, num_rows)
