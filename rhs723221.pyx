...
include 'C:/Python36/lib/site-packages/qutip/cy/complex_math.pxi'
...
def cy_td_ode_rhs(
        ...
        np.ndarray[np.float64_t, ndim=1] _td_array_1):
    ...
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], (0 if (t > 300.000000) else _td_array_0[int(round(999 * (t/300.000000)))]), out, num_rows)
    spmvpy(&data2[0], &idx2[0], &ptr2[0], &vec[0], (0 if (t > 300.000000) else _td_array_1[int(round(999 * (t/300.000000)))]), out, num_rows)
